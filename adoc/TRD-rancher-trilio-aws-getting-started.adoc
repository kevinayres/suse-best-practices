...
Set up DNS. In this example, I am using AWS R53 DNS for both by registrar and zones objects. 

We can see that the CNAME record for the Ingress controller matches the DNS name created during Ingress deployment. 
