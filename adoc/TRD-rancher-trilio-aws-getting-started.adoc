...
* Install a Kubernetes cluster using Rancher Kubernetes Engine on AWS EC2 via fully maintained Terraform based QuickStart.
  https://rancher.com/docs/rancher/v2.x/en/quick-start-guide/deployment/amazon-aws-qs/ 
* Deploy AWS EKS Cluster for production Pods.
