...
In this Solution Stack we're discussing Amazon S3 object storage as a backup target for TrilioVault. The S3 bucket can be deployed directly from TrilioVault. 
